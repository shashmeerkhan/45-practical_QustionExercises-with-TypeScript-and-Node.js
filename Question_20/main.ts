...
let countries: string[] = ["Pakistan", "Sudia Arab", "Dubai", "India", "Egypt"];
let cities: string[] = ["Karachi", "New york", "Mumbai", "Tokeyo", "paris"];
let language: string[] = ["English", "Urdu", "Arabic", "Hindi", "persian"];
