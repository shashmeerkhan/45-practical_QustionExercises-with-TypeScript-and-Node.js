...
//  information correctly. Add an optional parameter to make_album() that allows you to store the number of
//  tracks on an album. If the calling line includes a value for the number of tracks, add that value to the
...
let album1 = makeAlbum("Atif Aslam", "Dil Diyan Gallan");
let album2 = makeAlbum("Umair", "tag life", 20);
let album3 = makeAlbum("Talha Anjum", "100 Bars", 6);
console.log(album1);
console.log(album2);
console.log(album3);
export {};
